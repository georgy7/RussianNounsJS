/*!
  RussianNounsJS v1.4.2-SNAPSHOT
...
(function (root, factory) {
    ...
    const stressHashes = (() => {
        ...
        obj.a = extract([
            5860035, 137, 256, 370, 2338, 66, 332, 65, 2078, 733, 289, 1093, 130, 137789302,
            4881151, 2911766, 2158861, 264, 830279, 36691545, 2254564, 5866, 9678, 7062,
            70083, 22316, 1486, 3002, 72435, 15973, 3729, 1839, 37362138, 1688647, 4273632,
            4692534, 12619299, 817505, 15563233, 9000295, 27263219, 35473272, 3728615,
            19810908, 903082, 277299, 4582908, 1210678, 3335930, 2404611, 941853, 654463,
            1926507, 1735826, 1037516, 3549352, 23259951, 632071564, 1042741598, 220, 40470,
            53184, 5820, 6798, 22230, 69004, 2354, 10384, 148566, 21032, 38742, 4323, 30117,
            20406, 18315, 11770, 17698, 662, 17148, 27567, 13200, 63876, 3266, 17358, 4356,
            113036, 22067, 5556, 43195, 9956, 4796, 188056, 629155, 693627, 77385, 428010,
            84107, 68254, 48940, 574002, 41008, 98703, 12573, 4224, 2589, 9950, 4356, 103169,
            5512, 7622, 2432, 4851, 24584, 6248, 35563, 70290, 29469, 1, 38115, 31514, 21527,
            6854, 1696, 2660, 30492, 1419, 1553094, 116409, 43164, 14860, 48301, 18625,
            24189, 132824, 98902, 49356, 12539, 77386, 276, 7347, 83007, 20096, 40359,
            135322, 378784, 36125, 1419, 17172, 165, 16598, 84220, 10479, 49345, 10429,
            70444, 13068, 20064, 29931, 73305, 21184, 111431, 31581, 945251, 11353, 12225,
            628881782, 389618927, 340523673, 29404321, 194926684
        ]);

        obj.b = extract([
            5860035, 137, 256, 265, 1, 3039, 2677, 462, 133829607, 12363502, 1312212, 657796,
            2159084, 2484405, 5059494, 29650504, 792, 297, 1089, 6394, 15683, 29106, 25839,
            5676, 2211, 1914, 1023, 14190, 9670, 39599, 21516, 26136, 3267, 916, 9941, 2566,
            38849, 36907328, 503085, 1769229, 4546575, 15642, 42471, 14207042, 3575239,
            10675177, 42466538, 20517882, 9072822, 2540637, 13691997, 11282733, 414942,
            1203312, 2529985, 15352, 5849104, 621226, 2518460, 5742931, 3493868, 344633878,
            1354106233, 681, 162931, 34718, 59487, 39204, 41844, 42471, 37239, 26880, 34980,
            5358, 21735, 4026, 1419, 40239, 186, 93192, 23112, 25893, 4665, 780, 1858, 7590,
            3422, 12979, 24488, 9636, 789447, 1325378, 9979, 9205, 5511, 104511, 21780,
            361769, 285097, 3173, 50061, 66589, 53549, 26971, 23684, 11517, 576, 5331, 28423,
            102498, 18899, 50863, 320, 2853, 55272, 13749, 8712, 1419, 427129, 637991, 51478,
            516186, 35234, 107811, 18624, 59685, 32967, 212619, 32208, 65340, 6534, 7270,
            43232, 24639, 61555, 139557, 3173, 162081, 127555, 68003, 50094, 1419, 7293,
            9879, 26058, 34462, 26765, 24177, 903, 4356, 3453, 40633, 9275, 14027, 43876,
            1716, 29403, 15708, 17337, 85932, 3694, 87120, 60557, 9638, 588409, 509893,
            1286946188, 783020373
        ]);
        ...
        StressDictionary: class StressDictionary extends Dictionary {
            ...
            hasStressedEndingSingular(query, grCase) {
                ...
                if (caseIndex >= 0) {
                    ...
                    // У моих хэшей есть коллизия между словами 'рюш' и 'уж'.
                    if (!v && (query.getGender() === Gender.MASCULINE) && (query.lower() !== 'рюш')) {
