...
;function w(e){return S(p,e)}function b(e){return e.split("").filter(w).length}function I(e){
return e.replaceAll("ё","е").replaceAll("Ё","Е")}function W(e,t){return e.substring(0,e.length-t)}function m(e,t){
...
return["дитя","полудитя"].includes(e)?0:"мя"===m(e,2)?3:1;case s.COMMON:return"а"===i||"я"===i?2:"и"===i?-1:1;default:
...
const z=function(){const e=new k;return y.forEach(t=>e.addInteger(t)),P.forEach(t=>e.addInteger(t)),Object.freeze(e)}()
;function V(){const e=new Map,t=z.clone(),r=function(e){return 4294967296*(31&e._flags)+e._hash},i=function(e){
...
if(y.has(e._hash))return c("SEESEEE"[t]);if(P.has(e._hash))return c("SEEEEEE"[t])}}}return[]},
...
if(e.getGender()===s.MASCULINE&&(y.has(e._hash)||e.isAnimate()&&P.has(e._hash)))return c("E")}}return[]}}function D(e){
...
;r>=1040&&r<=1071?r+=32:r>=1024&&r<=1039&&(r+=80),t[n]=r}return String.fromCharCode.apply(null,t)}function X(e,t){
return t===t.toUpperCase()?e.toUpperCase():e}
const B=D(["ое","нький","ский","ской","лстой","отой","утой","евой","овой","живой"]),q=D(["ее","ое","нький","ский","ской","лстой","отой","утой"]),H=D(["евой","овой","отой","живой"]),J=D(["шний","жний","щий","ший","жий","чий"]),Y=["божий","ажий","яжий","ужий","южий","бульдожий","кабарожий","медвежий","носорожий","миножий"],K=D(Y),Q=D(Y.map(e=>W(e,2)+"ьи")),Z=new Set(["бубен","бугор","ветер","вошь","вымысел","горшок","деготь","дёготь","дятел","домысел","замысел","кашель","коготь","лапоть","лоб","локоть","ломоть","молебен","мох","ноготь","овен","пепел","пес","пёс","петушок","помысел","порошок","промысел","псалом","пушок","ров","рожь","рот","сон","стебель","стишок","угол","умысел","хребет","церковь","шов","ковер","овес","костер"].map(E)),$=new k
...
;function te(e,t){const n=O(t);if(S(-402111711,n)){if(S(p,_(t,2))){const n=W(e,2);return G(t,K)?n+X("ь",n):n}
...
return Z.has(e._hash)||G(n,ee)?W(t,3)+_(t,2):n.endsWith("ень")&&e.getGender()===s.MASCULINE&&!M(n,ne)?W(t,3)+"н":N(t)
}(e,r,t):(["лёд","лед","лён"].includes(t)||"лев"===t&&e.isAnimate())&&(c=W(r,2)+X("ь",_(r,2))+O(r))),
c||(c=function(e,t,n){
...
}(e,t,u)?W(r,2)+O(r):r),c}function se(e,t){const n=N(e),r=N(t.lower());if("а"===O(r))return n
;if(M(r,["зне","жне","гре","спе","мудре"])||m(N(r),3).split("").every(e=>S(A,e))||t.isAName())return n
;if("ле"===m(r,2)){const e=_(r,3);return S(p,e)||"л"===e?N(n)+"ь":n}
...
;function ae(e){
return M(e,["чек","шек"])&&e.length>=6||G(e,ie)||e.endsWith("ок")&&!e.endsWith("шок")&&!ce.includes(e)&&!M(e,ue)&&!S(p,_(e,3))&&(S(p,_(e,4))||M(W(e,2),["ст","рт"]))&&e.length>=4
}function oe(e,t,n){return(e.length?e:[!1]).map(e=>n(e?I(t):t,e))}const he=0,fe=3,le={"дочь":"дочерь","мать":"матерь"}
...
return f()||M(s,l)?i+"ей":h()?i+"ой":t.isASurname()&&!s.endsWith("да")?c+"ой":"ия"===m(s,2)?c+"и":s.endsWith("ничья")?c+"ей":c+"е"
...
const u=s.split(","),c=i instanceof Array?i:[o.U_SUFFIX];for(let s of u){t.text=s;const i=we(U.create(t));let u=e.get(i)
...
r(t,u(6),i,"снег"),e
}()),Ie=new Set("клей,чай,дом,дух,дым,дымок,газ,год,горошек,жар,жир,квас,пар,пыл,род,рост,сахар,свет,сироп,смех,снег,снежок,сок,сор,спор,срок,соус,спирт,страх,суп,сыр,табак,творог,толк,торф,туман,убыток,укроп,уксус,ход,цемент,чеснок,шаг,шик,шиповник,шоколад,шорох,шум,яд".split(",")),We=new k
;Ie.forEach(e=>We.addInteger(E(e)))
;const me=D(["й","ие","иё"]),Ne=D(["воробей","муравей","ручей","соловей","улей"]),Oe=D(["мой","ной","дой","шой","жой","рзой","осой","хой","латой","витой","литой","питой","житой","отой","утой","ятой","лагой","рагой","огой","угой","лубой","любой","илой","ылой","злой","малой","овой","евой","живой","ской","акой","укой","нний","ский","йкий","цкий","зкий","ткий","лкий","мкий","хкий","оркий","аркий","яркий","ький","ёкий","бокий","оокий","cокий","токий","ликий","дикий","укий","ыкий","який","пкий","дкий","бкий","нкий","жкий","чкий","гкий","овкий","авкий"])
;function _e(e,t){return"ый"===m(t,2)||(t.endsWith("кривой")||G(t,Oe))&&b(t)>=2}
...
;const d=()=>f&&i.endsWith("я")||Re(i),S=G(i,me),p=()=>G(i,Ne)?N(h)+X("ь",O(h)):h,g=()=>C("чщ",O(E));function A(e){
return!t.isAnimate()&&We.hasInteger(t._hash)&&Ie.has(i)&&("й"===u?e.push(N(r)+X("ю",O(r))):e=e.concat(oe(a,o,e=>e+X("у",O(e))))),
e}switch(n){case 0:return r;case 1:switch(u){case"и":case"ы":if(f)return Te(e,t,n,i);break;case"й":case"е":
if(S&&t.isASurname()||_e(0,i)||G(i,B))return o+"ого";if(G(i,J)||i.endsWith("ее"))return o+"его";case"ё":case"я":case"ь":
...
if(f)return Te(e,t,n,i);break;case"й":case"е":if(S&&t.isASurname()||_e(0,i)||G(i,B))return o+"ому"
;if(G(i,J)||i.endsWith("ее"))return o+"ему";case"ё":case"я":case"ь":if(S)return p()+"ю";if(d()&&!g())return o+"ю";break
...
;break;case"й":case"е":case"ё":case"я":case"ь":if(S&&t.isASurname()||G(i,q))return G(i,Me)?o+"ым":o+"им"
;if(_e(0,i))return"и"===_(i,2)||i.endsWith("хой")?o+"им":o+"ым";if(G(i,H))return o+"ым";if(G(i,J))return o+"им"
...
case"ь":if(S&&t.isASurname()||_e(0,i)||G(i,B))return o+"ом";if(G(i,J)||i.endsWith("ее"))return o+"ем"
;if(M(i,["воробей"])){const e=N(h);return e+X("ье",O(e))}
if(G(i,Ce)&&!M(i,["запястье","здоровье","изголовье","платье"]))return h+"и";if("й"===u||"иё"===m(i,2))return p()+"е"
...
return Se(e,T(t,N(s())+("ни"===m(r,2)?"я":"а")),n)}function xe(e){
...
;const i=xe(n)&&n.endsWith("я")||Re(n);return"й"===O(n)?I(s)+"ю":i?I(r)+"ю":ae(n)?I(N(s))+"ку":I(r)+"у"}
if(o.PREPOSITIONAL===n)return Ue(e,t,5)}function Re(e){
return"ь"===O(e)&&!e.endsWith("господь")||C("её",O(e))&&!M(e,["це","же"])}
const ye=new k,Pe=Object.freeze([[[s.MASCULINE,void 0],{"болгарин":["болгары"],"господин":["господа"],
...
;function d(){const e=l,t=v(e).indexOf("ье"),n=X("и",e[t]);return e.substring(0,t)+n+e.substring(t+1)}function g(){
...
n.push(l+"ы")):Array.prototype.push.apply(n,oe(u,l,e=>e+"ы"))}const A=function(e,t){if(ye.hasInteger(e._hash)){
const n=e.getGender(),r=e.isAnimate();for(const[e,s]of Pe){const i=e[0],u=e[1]
...
;n.push(W(r,3)+"ети")}break;case 1:if(ke.includes(i))n.push(w+"я");else if(s.MASCULINE===h){
...
n.push(w+"я")):s.includes(i)?n.push(w+"я"):Fe.has(i)||G(i,je)||ze.has(i)||Ve.has(i)?(Ve.has(i)&&g(),
Re(i)?Array.prototype.push.apply(n,o(e=>e+"я")):u.includes(!0)?n.push(I(c)+"а"):n.push(c+"а"),
ze.has(i)&&g()):(i.endsWith("анин")&&i.length>5||i.endsWith("янин"))&&!t.isAName()||["барин","боярин"].includes(i)?(n.push(W(r,2)+"е"),
"барин"===i&&n.push(W(r,2)+"ы")):["цыган"].includes(i)?n.push(r+"е"):"щенок"===i?(n.push(W(r,2)+"ки"),
n.push(W(r,2)+"ята")):!i.endsWith("ребёнок")&&!i.endsWith("ребенок")||i.endsWith("жеребёнок")||i.endsWith("жеребенок")||i.endsWith("ястребёнок")||i.endsWith("ястребенок")?(i.endsWith("ёнок")||i.endsWith("енок"))&&t.isAnimate()?n.push(W(r,4)+"ята"):i.endsWith("ёночек")&&t.isAnimate()?n.push(W(r,6)+"ятки"):i.endsWith("онок")&&C("жшч",_(i,5))&&t.isAnimate()?n.push(W(r,4)+"ата"):ae(i)?n.push(W(r,2)+"ки"):G(i,J)?M(i,Y)?n.push(W(r,2)+"ьи"):n.push(N(r)+"е"):_e(0,i)?i.endsWith("ый")||i.endsWith("ий")?n.push(N(r)+"е"):i.endsWith("ой")&&!M(i,["хой","ской"])?n.push(W(r,2)+"ые"):n.push(W(r,2)+"ие"):i.endsWith("его")?n.push(W(r,3)+"ие"):["воробей","муравей","ручей","соловей","улей","жеребей","ирей","репей","чирей"].includes(i)?n.push(W(r,2)+"ьи"):g():n.push(W(r,7)+"дети")
...
;break;case 3:
"мя"===m(i,2)?n.push(c+"ена"):Object.keys(le).includes(i)?n.push(N(le[i])+"и"):s.FEMININE===h?n.push(l+"и"):"и"===O(l)?n.push(l+"я"):n.push(l+"а")
}return Ae(n)}
const Ge=D(["ли","си","би","ви","ди","ти","пи","ри","ни","фи","зи","ьи","ья","ия","ря","ля","ая","аи","ои","уи","эи","ыи","яи","ёи","юи","еи","ии"]),ve=["беготни","болтовни","будни","вожжи","возни","доли","лапши","левши","люди","марли","моря","мощи","ноздри","пени","пятерни","распри","родни","сакли","сени","ступни","судьи","фигни","чукчи"],Xe=["головы","громадины","детины","деревенщины","дохлятины","дубины","ехидины","жадины","зверины","идиотины","кислятины","молодчины","орясины","остолопины","сиротины","скотины","старейшины","старины","старшины","уродины"],Be=D(Xe),qe=["адреса","паспорта","поезда","цеха","снега","бункера","буфера","берега","вымпела","голоса","города","директора","договора","доктора","жемчуга","инспектора","инструктора","колокола","кондуктора","короба","корпуса","крейсера","кузова","леса","мастера","номера","облачка","острова","отпуска","паруса","повара","погреба","пояса","провода","прожектора","пропуска","рукава","сахара","свитера","сервера","счета","трактора","тормоза","холода","цвета","черепа","шторма","штуцера","юнкера","ястреба","суда","корм"],He=D(qe),Je=new Set(qe.concat(["бега","беглецы","близнецы","бойцы","бока","борта","борцы","бруствера","брюшки","веера","века","венцы","верха","веса","весы","вечера","вороха","глупцы","года","гонцы","дворцы","дельцы","детдома","детдомы","дома","жеребцы","жильцы","жрецы","затишки","зубцы","излишки","истцы","катера","концы","корма","кузнецы","купола","купцы","лишки","луга","мертвецы","меха","мудрецы","облака","образа","образцы","огурцы","округа","омута","ордена","ордера","отцы","очки","певцы","песцы","пловцы","подлецы","продавцы","птенцы","резцы","рога","рода","рубцы","самцы","свинцы","сорта","соуса","спецы","стога","столбцы","стрельцы","творцы","тельцы","тенора","терема","тома","тона","торцы","хлеба","штришки","юнцы"])),Ye=new Set(["авары","аланы","аршины","баклажаны","буквы","гольфы","граммы","гусары","дела","кадеты","килограммы","омы","помидоры","рентгены","ботинки","человеки","чулки","шорты"]),Ke=new Set(["гектары","рельсы"]),Qe=new k
;Je.forEach(e=>Qe.addRaw(j(e))),Ye.forEach(e=>Qe.addRaw(j(e))),Ke.forEach(e=>Qe.addRaw(j(e)))
;const Ze=new Set(Xe.concat(["абазины","авы","аввы","бедняги","бедолаги","болгары","бродяги","брызги","брюки","брюхи","будды","бусы","валенки","веки","вельможи","верзилы","вилы","владыки","воеводы","волосы","вояки","главы","грузины","задворки","задиры","железы","жилы","зануды","зеваки","именины","калеки","кальсоны","каникулы","колготки","коллеги","крохи","курицы","куры","ладоши","ламы","лыки","макароны","мужчины","нападки","нары","непоседы","носилки","ножны","папы","папаши","таты","падлы","партизаны","погоны","поминки","посиделки","похороны","предтечи","работяги","разы","ребятки","румыны","самоубийцы","санки","убийцы","сапоги","сатаны","сироты","сливки","слуги","солдаты","старосты","сумерки","сутки","татары","телеса","хитрюги","четвереньки","шляпы","шмотки","яблоки","дядьки","дяденьки","зайки","кроссовки","малютки","малолетки","попки","турки","узы","хлопоты","шахматы"])),$e=new k
;Ze.forEach(e=>$e.addRaw(j(e)))
...
const o=t.getGender(),h=i.endsWith("цы")?N(r):te(r,i),f=G(i,ge)&&(t.isASurname()||o===s.COMMON)&&!G(i,Be),l=3*Math.min(Math.round(et.length/3-1),a-2)
;if(f||i.endsWith("ничьи"))return r+et[l];if(i.endsWith("ые"))return W(r,2)+et[l+1]
;if(i.endsWith("ие")||G(i,Q))return h+et[l+2];if(a>2&&4!==a){const s=2,u=s*Math.min(Math.round(tt.length/s-1),a-3)
;return G(i,Ge)?N(r)+tt[u]:e.sd.hasStressedEndingPlural(t,n).includes(!0)?I(h)+tt[u+1]:h+tt[u+1]}{
...
const e=O(h);return N(h)+X("о",e)+e}if(G(i,nt)&&!i.endsWith("недра")||M(i,u)){const e=_(r,2);return W(r,2)+X("е",e)+e}
if(M(i,["сестры","сёстры","серьги"])){const e=_(r,2);return("ь"===_(i,3)?I(W(r,3)):I(W(r,2)))+X("ё",e)+e}
if(M(s,["льц","сьм","деньг","ьк","йк","дьб"])){const e=O(h);return W(h,2)+X("е",e)+e}
return M(i,["сла","слы"])?N(h)+"ел":h};if([3,0].includes(c)){if(i.endsWith("и"))return N(r)+"ей"
;if(["гроздья"].includes(i))return N(r)+"ев"}const f=_(i,3);if(s.FEMININE!==o){const e=j(i),n=Qe.hasRaw(e)
;if(n&&Je.has(i))return N(r)+"ов";if(n&&Ye.has(i)&&!t.isAName())return[a(),N(r)+"ов"]
...
if("и"===u)return i.endsWith("ульи")?N(r)+"ев":i.endsWith("ьи")?s.MASCULINE===o?N(r)+"ёв":W(r,2)+"ей":["ча","кле","холу","ху"].includes(N(i))?N(r)+"ёв":i.endsWith("ищи")?a():i.endsWith("мессии")?N(r)+"й":S(p,_(i,2))?N(r)+"ев":!G(i,ut)||s.MASCULINE===o&&!G(I(i),it)||G(t.lower(),ct)?N(r)+"ов":a()
...
return M(i,["семена","стремена"])?W(r,3)+"ян":i.endsWith("мена")?W(r,3)+"ён":t.lower().endsWith("яйцо")?X("яиц",N(r)):i.endsWith("нца")?[a(),N(r)+"ев"]:G(i,He)?N(r)+"ов":a()
...
;return W(r,3)+X("е",e)+e}if(C("жшч",f))return a();if(S(A,f))return W(r,2)+"ок"}if(ve.includes(i))return N(r)+"ей"
...
;if(v(h).endsWith("ийк"))return W(h,2)+"ек";if(h.length===i.length-1&&G(i,Ge)){if(C("ьй",v(_(h,2)))&&!t.isAnimate()){
const e=O(h);return W(h,2)+X("е",e)+e}return M(i,["земли","петли","пли","вли"])?N(h)+"ель":h+"ь"}return a()}}class ot{
...
export{e as CASES,t as Case,ot as Engine,s as Gender,U as Lemma,c as LocativeForm,a as LocativeFormAttribute,V as StressDictionary,L as createLemma,R as createLemmaOrNull};
