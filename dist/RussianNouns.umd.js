...
var g=3892855073,b=66567902,C=66567390;function m(e){return T(g,O(e))}function y(e,r){
...
var n=new k(e);return n._txt=r,n._lc=r.toLowerCase(),n._hash=p(n.lower()),Object.freeze(n)}function j(e){
...
return _(e,2)+"ьи"
})),ue=new Set(["бубен","бугор","ветер","вошь","вымысел","горшок","деготь","дёготь","дятел","домысел","замысел","кашель","коготь","лапоть","лоб","локоть","ломоть","молебен","мох","ноготь","овен","пепел","пес","пёс","петушок","помысел","порошок","промысел","псалом","пушок","ров","рожь","рот","сон","стебель","стишок","угол","умысел","хребет","церковь","шов","ковер","овес","костер"].map(p)),ae=new G
...
return[i+"тей",i+"тею"]}}function pe(e,r,t){var i=r.text(),u=r.lower(),a=oe(r,u),s=O(a),c=R(i),f=R(u),o=function(){
...
return h()||V(u,E)?a+"ей":l()?a+"ой":r.isASurname()&&!u.endsWith("да")?c+"ой":"ия"===U(u,2)?c+"и":u.endsWith("ничья")?c+"ей":c+"е"
}}var Oe=$(["ов","ев","ёв","ин","ын"]),Ne=function(e,r){for(var n=r,t=0;t<e.length;t++){var i=e.charCodeAt(t),u=n
;(n=new Map).set(i,u)}return n}("ы",Oe);function Te(e){return e.filter(function(r,n){return e.indexOf(r)===n})}
...
e.set(d,v));var I,A=S(t);try{for(A.s();!(I=A.n()).done;){var p,O=I.value,N=S(o);try{for(N.s();!(p=N.n()).done;){
var T=p.value;v.push(f(O,T,n))}}catch(e){N.e(e)}finally{N.f()}}}catch(e){A.e(e)}finally{A.f()}}}catch(e){l.e(e)}finally{
...
;Ce.forEach(function(e){return me.addInteger(p(e))})
...
;function Le(e,r,t){
var u=r.text(),a=O(u),s=L(a),c=r.getGender(),f=e.sd.hasStressedEndingSingular(r,t),l=oe(r,a,f[0]),h=R(u),E=Ve(a)
;E&&(l="полу"+l.substring(3),h="полу"+h.substring(3));var d=O(l),S=function(){return E&&a.endsWith("я")||ke(a)
},v=K(a,ye),I=function(){return K(a,we)?R(h)+y("ь",L(h)):h},A=function(){return"чщ".includes(L(d))};function p(e){
...
;if(K(a,re)||a.endsWith("ее"))return l+"его";case"ё":case"я":case"ь":if(v)return p([I()+"я"]);if(S()&&!A())return l+"я"
;break;case"ц":return le(u,r)+"ца";case"к":if(Se(a))return R(h)+"ка";break;case"о":
if(V(a,["шко"])&&i.MASCULINE===c)return h+"и"}return p(r.isASurname()||-1===d.indexOf("ё")?[l+"а"]:P(f,l,function(e){
...
case"в":if(r.isASurname()&&K(a,Oe))return u+"ым"}return S()||"жшчщ".includes(L(d))?P(f,l,function(e,r){
...
;return"полпути"===t?Ae(e,x(r,R(i())+"ь"),n):t.endsWith("зни")||t.endsWith("сти")?Ie(e,x(r,R(i())+"ь"),n):pe(e,x(r,R(i())+("ни"===U(t,2)?"я":"а")),n)
...
;Object.keys(De[1]).map(function(e){return je.addInteger(p(e))})}}catch(e){ze.e(e)}finally{ze.f()}
...
;function Ye(e,r){var t=[],u=r.text(),a=O(u),s=e.sd.hasStressedEndingPlural(r,n.NOMINATIVE);Object.freeze(s)
;var c=oe(r,a,s[0]),f=O(c);if(a.endsWith("яя"))return t.push(_(u,2)+"ие"),Te(t);var o=function(t){
...
var e=E,r=O(e).indexOf("ье"),n=y("и",e[r]);return e.substring(0,r)+n+e.substring(r+1)}function A(){
...
return e+"ы"}))}if(je.hasInteger(r._hash)){var p,N=S(Fe);try{for(N.s();!(p=N.n()).done;){
var b=v(p.value,2),C=b[0],m=b[1],w=C[0],k=C[1];if(l===w&&(null==k||k===r.isAnimate())&&m.hasOwnProperty(a)){
...
;function Sr(e,n,t,u){var a=O(u),s=L(a),c=N(s),f=r.indexOf(t)+1;if(1===f||4===f&&!n.isAnimate())return u
...
;if(i.FEMININE!==o){var A=J(a),p=ir.hasRaw(A);if(p&&rr.has(a))return R(u)+"ов"
;if(p&&nr.has(a)&&!n.isAName())return[v(),R(u)+"ов"];if(p&&tr.has(a))return[R(u)+"ов",v()]
...
;if(O(l).endsWith("ийк"))return _(l,2)+"ек";if(l.length===a.length-1&&K(a,qe)){
if("ьй".includes(O(M(l,1)))&&!n.isAnimate()){var m=L(l);return _(l,2)+y("е",m)+m}
...
;case 1:return Pe(e,n,t);case 2:return pe(e,n,Case.PREPOSITIONAL);case 3:return Ie(e,n,Case.PREPOSITIONAL)}
...
;switch(r.getDeclension()){case-1:return i;case 0:return Ae(e,r,n);case 1:return Le(e,r,n);case 2:return pe(e,r,n)
;case 3:return Ie(e,r,n)}}(e,r,n,t);return i instanceof Array?i:[i]}e.CASES=r,e.Case=n,e.Engine=vr,e.Gender=i,e.Lemma=k,
e.LocativeForm=u,e.LocativeFormAttribute=a,e.StressDictionary=q,e.createLemma=function(e){return k.create(e)},
e.createLemmaOrNull=function(e){return k.createOrNull(e)}});
