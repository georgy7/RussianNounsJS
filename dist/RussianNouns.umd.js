...
EXPOSURE:512,MOTION:1024,EVENT:2048,WITH_ADJECTIVE:4096,WITHOUT_ADJECTIVE:8192,RELIGIOUS:16384}),f=Object.freeze({
PREPOSITIONAL:1,U_SUFFIX:2}),c=Object.freeze({V:1,VO:2,NA:3});function o(e,r,n){return n<<6|(e-1&7)<<3|r-1&7}
...
Object.defineProperty(e,g(t.key),t)}}function S(e,r,n){return r&&d(e.prototype,r),n&&d(e,n),
...
if(c)throw i}}return s}}(e,r)||A(e,r)||function(){
throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
}()}function g(e){var r=function(e,r){if("object"!=typeof e||!e)return e;var n=e[Symbol.toPrimitive];if(void 0!==n){
...
var a,s=v(r);try{for(s.s();!(a=s.n()).done;){var f=a.value.charCodeAt(0)-1072&31;n|=f<<t,(t+=5)>=8&&u()}}catch(e){s.e(e)
}finally{s.f()}t>0&&u();var c=r.charCodeAt(0)%2;return 2*(2147483647&i)+c}function b(e){var r=e.charCodeAt(0)-1072
;return 33===r?32:r===(31&r)?1<<r:0}function O(e,r){return 0!==(e&b(r))}var m=3892855073,N=66567902,y=66567390
;function C(e){return O(m,e)}function w(e){return e.split("").filter(C).length}function T(e){
...
return"а"===i||"я"===i?2:O(N,i)?-1:3;case u.MASCULINE:return"а"===i||"я"===i?2:"путь"===e?0:1;case u.NEUTER:
...
key:"createOrNull",value:function(e){return null===j(e)?Object.freeze(new this(e)):null}}])}();function F(e,r){
var n=new x(e);return n._txt=r,n._lc=r.toLowerCase(),n._hash=I(n.lower()),Object.freeze(n)}function j(e){
...
;if(2!==a.length||s(a[0],7)||s(a[1],6))throw new Error("Bad settings format.");var f=x.create(t),c=n(f),o=e.get(c)
;o instanceof Array||(o=[],e.set(c,o));var h=65535&f._flags|i(f)<<16,l=o.find(function(e){return h===e[0]})
;l?l[1]=u:o.push([h,u]),r.addInteger(f._hash)};var s=function(e){switch(e){case"E":return[!0];case"e":return[!0,!1]
;case"b":case"s":return[!1,!0];default:return[!1]}};this.hasStressedEndingSingular=function(e,n){
if(r.hasInteger(e._hash)){var i=t(n);if(i>=0){var f=a(e);if(f){var c=f.split("-")[0];return s(c[i])}
if(e.getGender()===u.MASCULINE){if(V.has(e._hash))return s("SEESEEE"[i]);if(D.has(e._hash))return s("SEEEEEE"[i])}}}
return[]},this.hasStressedEndingPlural=function(e,n){if(r.hasInteger(e._hash)){var i=t(n);if(i>=0&&i<6){var f=a(e)
;if(f){var c=f.split("-")[1];return s(c[i])}
...
;if(a>0){var f=u.get(s);if(0===f)break;void 0===f&&u.set(s,new Map),u=u.get(s)}else u.set(s,0)}}catch(e){t.e(e)}finally{
...
;var fe=q(["овёс","ковёр","костёр","шатер","шатёр","козел","козёл","котел","котёл","орел","орёл","осел","осёл","узел","уголь","чок","ешок","хол"])
;function ce(e,r){var n=R(r);if(O(-402111711,n)){if(O(m,M(r,2))){var t=W(e,2);return $(r,ie)?t+Q("ь",t):t}
if("й"!==n)return U(e)}return e}var oe=["ясень","бюллетень","олень","тюлень","гордень","пельмень","ячмень"]
;function he(e,r,n){var t,i=e.text(),a=R(r),s=b(a);return-133667019&s&&(-402111711&s?t=function(e,r,n){var t=M(r,2)
;return"ь"===t||"о"===n&&O(2504708,t)?U(e):ce(e,r)}(i,r,a):"к"===a?t=function(e,r,n){
return e.length>=4&&k(r,["рёк","нёк","лёк"])&&!1!==n?W(e,2)+"ьк":r.endsWith("ёк")&&O(m,M(r,3))?W(e,2)+"йк":void 0
}(i,r,n):"ь"===a?t=function(e,r,n){
return ae.has(e._hash)||$(n,fe)?W(r,3)+M(r,2):n.endsWith("ень")&&e.getGender()===u.MASCULINE&&!k(n,oe)?W(r,3)+"н":U(r)
}(e,i,r):(["лёд","лед","лён"].includes(r)||"лев"===r&&e.isAnimate())&&(t=W(i,2)+Q("ь",M(i,2))+R(i))),
t||(t=function(e,r,n){
return!!(199680&n)&&$(r,fe)&&!["новосел","новосёл"].includes(r)||!!(2571270&n)&&(se.hasInteger(e._hash)&&ae.has(e._hash)||e.isAnimate()&&r.endsWith("посол"))
}(e,r,s)?W(i,2)+R(i):i),t}function le(e,r){var n=U(e),t=U(r.lower());if("а"===R(t))return n
;if(k(t,["зне","жне","гре","спе","мудре"])||_(U(t),3).split("").every(function(e){return O(y,e)})||r.isAName())return n
;if("ле"===_(t,2)){var i=M(t,3);return O(m,i)||"л"===i?U(n)+"ь":n}
return O(m,R(t))&&"и"!==R(t)?O(m,R(U(t)))?W(e,2)+"й":k(r.lower(),["месяц"])?n:W(e,2):n}
...
;function ve(e){
return k(e,["чек","шек"])&&e.length>=6||$(e,Ee)||e.endsWith("ок")&&!e.endsWith("шок")&&!Se.includes(e)&&!k(e,de)&&!O(m,M(e,3))&&(O(m,M(e,4))||k(W(e,2),["ст","рт"]))&&e.length>=4
}function pe(e,r,n){return(e.length?e:[!1]).map(function(e){return n(e?T(r):r,e)})}var ge=0,Ae=3,Ie={"дочь":"дочерь",
"мать":"матерь"};function be(e,r,n){var t=r.text(),i=r.lower()
;if(![ge,Ae].includes(n)&&Object.keys(Ie).includes(i))return be(e,F(r,Ie[i]),n);var u=he(r,i);if(function(e){
return e.endsWith("полночь")||e.startsWith("пол")&&O(134217984,R(e))&&w(e)>=2}(i)&&(u="полу"+u.substring(3)),
"мя"===_(i,2))switch(n){case ge:case Ae:return t;case 1:case 2:case 5:case 6:return u+"ени";case 4:return u+"енем"
}else switch(n){case ge:case Ae:return t;case 1:case 2:case 5:case 6:return u+"и";case 4:
return k(i,["вошь","рожь","церковь"])?t+"ю":u+"ью"}}function Oe(e,r,n){var t=r.text(),i=r.lower()
;if(i.endsWith("путь"))return 4===n?U(t)+"ём":be(e,r,n);if(!i.endsWith("дитя"))throw new Error("unsupported");switch(n){
case 0:case 3:return t;case 1:case 2:case 5:case 6:return t+"ти";case 4:return[t+"тей",t+"тею"]}}function me(e,r,n){
var t=r.text(),i=r.lower(),u=he(r,i),a=K(u),s=U(t),f=U(i),c=function(){return"я"===R(i)},o=function(){
return i.endsWith("ая")&&!(2===w(i)||O(m,R(a)))},h=function(){return i.endsWith("яя")&&!(2===w(i)||O(m,R(a)))
},l=["жая","шая"];switch(n){case 0:return t;case 1:
return h()||k(i,l)?u+"ей":o()?u+"ой":r.isASurname()&&!i.endsWith("да")?s+"ой":i.endsWith("ничья")?s+"ей":c()||O(60818504,R(a))?s+"и":s+"ы"
...
return h()||k(i,l)?u+"ею":o()?[u+"ой",u+"ою"]:c()||L("жшчщц",R(a))&&!e.sd.hasStressedEndingSingular(r,n).includes(!0)?"и"===R(f)?s+"ей":[s+"ей",s+"ею"]:[s+"ой",s+"ою"]
}}var Ne=q(["ов","ев","ёв","ин","ын"]),ye=function(e,r){for(var n=r,t=0;t<e.length;t++){var i=e.charCodeAt(t),u=n
;(n=new Map).set(i,u)}return n}("ы",Ne);function Ce(e){return e.filter(function(r,n){return e.indexOf(r)===n})}
...
;function t(r,n,t,i,u){var a,s=i.split(","),c=u instanceof Array?u:[f.U_SUFFIX],h=v(s);try{for(h.s();!(a=h.n()).done;){
var l=a.value;r.text=l;var E=we(x.create(r)),d=e.get(E);d||(d=[],e.set(E,d));var S,p=v(t);try{
for(p.s();!(S=p.n()).done;){var g,A=S.value,I=v(c);try{for(I.s();!(g=I.n()).done;){var b=g.value;d.push(o(A,b,n))}
}catch(e){I.e(e)}finally{I.f()}}}catch(e){p.e(e)}finally{p.f()}}}catch(e){h.e(e)}finally{h.f()}}
var i=[c.V],a=[c.VO],h=[c.NA];t(r,s.CONTAINER,i,"мозг,пруд,стог,таз,год"),t(r,s.CONTAINER,a,"рот"),t(r,s.WAY,i,"год"),
t(r,s.CONTAINER,i,"гроб"),t(r,s.CONTAINER|s.RELIGIOUS,a,"гроб",[f.PREPOSITIONAL]),
...
t(r,s.OBJECT_WITH_FUNCTIONAL_SURFACE,h,"крюк,болт",[f.PREPOSITIONAL,f.U_SUFFIX]);var l=",мёд,мех,пар,пух"
...
;function Fe(e,r,n){
var t=r.text(),i=K(t),a=R(i),s=r.getGender(),f=e.sd.hasStressedEndingSingular(r,n),c=he(r,i,f[0]),o=U(t),l=Pe(i)
;l&&(c="полу"+c.substring(3),o="полу"+o.substring(3));var E=K(c),d=function(){return l&&i.endsWith("я")||De(i)
},S=$(i,Ue),v=function(){return $(i,Re)?U(o)+Q("ь",R(o)):o},p=function(){return L("чщ",R(E))};function g(e){
return!r.isAnimate()&&_e.hasInteger(r._hash)&&We.has(i)&&("й"===a?e.push(U(t)+Q("ю",R(t))):e=e.concat(pe(f,c,function(e){
return e+Q("у",R(e))}))),e}switch(n){case 0:return t;case 1:switch(a){case"и":case"ы":if(l)return je(e,r,n,i);break
;case"й":case"е":if(S&&r.isASurname()||Le(0,i)||$(i,Z))return c+"ого";if($(i,ne)||i.endsWith("ее"))return c+"его"
;case"ё":case"я":case"ь":if(S)return g([v()+"я"]);if(d()&&!p())return c+"я";break;case"ц":return le(t,r)+"ца";case"к":
if(ve(i))return U(o)+"ка";break;case"о":if(k(i,["шко"])&&u.MASCULINE===s)return o+"и"}
return g(r.isASurname()||-1===E.indexOf("ё")?[c+"а"]:pe(f,c,function(e){return e+"а"}));case 2:switch(a){case"и":
case"ы":if(l)return je(e,r,n,i);break;case"й":case"е":if(S&&r.isASurname()||Le(0,i)||$(i,Z))return c+"ому"
;if($(i,ne)||i.endsWith("ее"))return c+"ему";case"ё":case"я":case"ь":if(S)return v()+"ю";if(d()&&!p())return c+"ю";break
;case"ц":return le(t,r)+"цу";case"к":if(ve(i))return U(o)+"ку"}
return r.isASurname()||-1===E.indexOf("ё")?c+"у":pe(f,c,function(e){return e+"у"});case 3:
return s===u.NEUTER||L("иы",a)&&l?t:r.isAnimate()?Fe(e,r,1):t;case 4:switch(a){case"и":case"ы":if(l)return je(e,r,n,i)
;break;case"й":case"е":case"ё":case"я":case"ь":if(S&&r.isASurname()||$(i,ee))return $(i,xe)?c+"ым":c+"им"
;if(Le(0,i))return"и"===M(i,2)||i.endsWith("хой")?c+"им":c+"ым";if($(i,re))return c+"ым";if($(i,ne))return c+"им"
;if(S)return v()+"ем";if(i.endsWith("це"))return t+"м";break;case"ц":return pe(f,t,function(e,n){
return n?le(e,r)+"цом":le(e,r)+"цем"});case"к":if(ve(i))return U(o)+"ком";break;case"н":case"в":
if(r.isASurname()&&$(i,Ne))return t+"ым"}return d()||L("жшчщ",R(E))?pe(f,c,function(e,r){return r?e+"ом":e+"ем"
}):r.isASurname()||-1===E.indexOf("ё")?c+"ом":pe(f,c,function(e){return e+"ом"});case 6:if("полпути"===i)return t
;var A=Te.get(we(r));if(A)return Ce(A.map(function(e){return h(e)})).map(function(n){return Ve(e,r,n)});case 5:
switch(a){case"и":if("полпути"===i)return t;case"ы":if(l)return je(e,r,n,i);break;case"й":case"е":case"ё":case"я":
case"ь":if(S&&r.isASurname()||Le(0,i)||$(i,Z))return c+"ом";if($(i,ne)||i.endsWith("ее"))return c+"ем"
...
return r.isASurname()||-1===E.indexOf("ё")?c+"е":pe(f,c,function(e){return e+"е"})}}function je(e,r,n,t){
var i=function(){return"полминуты"!==t?"полу"+r.text().substring(3):r.text()}
;return"полпути"===t?Oe(e,F(r,U(i())+"ь"),n):t.endsWith("зни")||t.endsWith("сти")?be(e,F(r,U(i())+"ь"),n):me(e,F(r,U(i())+("ни"===_(t,2)?"я":"а")),n)
}function Pe(e){if(e.startsWith("пол")&&O(2550137089,R(e))&&"л"!==e[3]&&w(e)>=2){
var r=e.substring(3),n=r.search(/[а-яё]/);return n>=0&&O(N,r[n])}return!1}function Ve(e,r,n){if(f.U_SUFFIX===n){
var t=r.text(),i=r.lower(),u=he(r,i),a=U(t),s=Pe(i)&&i.endsWith("я")||De(i)
;return"й"===R(i)?T(a)+"ю":s?T(u)+"ю":ve(i)?T(U(a))+"ку":T(u)+"у"}if(f.PREPOSITIONAL===n)return Fe(e,r,5)}
...
;var s=he(r,i,a[0]),f=K(s);if(i.endsWith("яя"))return n.push(W(t,2)+"ие"),Ce(n);var c=function(n){
var t=e.sd.hasStressedEndingPlural(r,0).map(function(e){return!e});return t.length?t.map(function(e){
return e?1===f.replace(/[^её]/g,"").length?n(function(e){
...
},o=r.getGender(),h=r.getDeclension(),l=("й"===R(i)||O(m,R(i)))&&O(m,R(U(i)))?U(t):s,E=function(){
...
O(60818504,R(f))||L("яйь",R(i))||k(i,["сосед"])?E()?(n.push(d()+"и"),
...
return e+"ы"}))}var g=function(e,r){if(Be.hasInteger(e._hash)){var n,t=e.getGender(),i=e.isAnimate(),u=v(He);try{
for(u.s();!(n=u.n()).done;){var a=p(n.value,2),s=a[0],f=a[1],c=s[0],o=s[1]
;if(t===c&&(null==o||o===i)&&f.hasOwnProperty(r))return f[r].slice()}}catch(e){u.e(e)}finally{u.f()}}}(r,i)
;if(g)return g;var A="ь"===R(f)?s:"к"===R(f)?U(s)+"чь":"г"===R(f)?U(s)+"зь":"й"===R(i)?U(t):k(i,["рь","ль"])?s:s+"ь"
...
if(Xe.includes(i))n.push(A+"я");else if(u.MASCULINE===o){"сын"===i?(n.push("сыновья"),
S()):"человек"===i?(n.push("люди"),
S()):["крюк","лист","лоскут","повод","прут","сук","учитель","флигель","штабель"].includes(i)||"соболь"===i&&r.isAnimate()?(S(),
n.push(A+"я")):["клин","колос","ком","край","соболь"].includes(i)?n.push(A+"я"):Ye.has(i)||$(i,qe)||$e.has(i)||Ke.has(i)?(Ke.has(i)&&S(),
De(i)?Array.prototype.push.apply(n,c(function(e){return e+"я"})):a.includes(!0)?n.push(T(s)+"а"):n.push(s+"а"),
...
var s=R(o);return U(o)+Q("о",s)+s}if($(i,Er)&&!i.endsWith("недра")||k(i,a)){var f=M(t,2);return W(t,2)+Q("е",f)+f}
if(k(i,["сестры","сёстры","серьги"])){var c=M(t,2);return("ь"===M(i,3)?T(W(t,3)):T(W(t,2)))+Q("ё",c)+c}
...
;if(u.FEMININE!==c){var p=J(i),g=fr.hasRaw(p);if(g&&ur.has(i))return U(t)+"ов"
;if(g&&ar.has(i)&&!r.isAName())return[S(),U(t)+"ов"];if(g&&sr.has(i))return[U(t)+"ов",S()]
;if(c===u.COMMON&&!k(i,er)&&!L("жшч",v)||or.hasRaw(p)&&cr.has(i)||r.isAName()&&c===u.MASCULINE&&r.lower().endsWith("а")||"барин"===r.lower())return S()
;switch(a){case"и":case"я":
if($(i,dr)||"щи"===i||er.includes(i)||r.lower().endsWith("ь")&&!k(r.lower(),["зять","деверь"]))return("ь"===R(U(i))?W(t,2):U(t))+"ей"
;if("и"===a)return i.endsWith("ульи")?U(t)+"ев":i.endsWith("ьи")?u.MASCULINE===c?U(t)+"ёв":W(t,2)+"ей":["ча","кле","холу","ху"].includes(U(i))?U(t)+"ёв":i.endsWith("ищи")?S():i.endsWith("мессии")?U(t)+"й":O(m,M(i,2))?U(t)+"ев":!$(i,pr)||u.MASCULINE===c&&!$(T(i),vr)||$(r.lower(),gr)?U(t)+"ов":S()
;if($(i,Sr))return U(t)+"ев";if(k(i,["зятья","кумовья","деверья","края","острия"]))return U(t)+"ёв"
;if(k(i,["ья","ия"]))return u.MASCULINE===c?W(t,2)+"ей":W(t,2)+"ий";break;case"а":
...
if(i.endsWith("не"))return S()}}if(i.endsWith("йки"))return W(t,3)+"ек";if(i.endsWith("ки")){if("ь"===v){var A=R(U(t))
;return W(t,3)+Q("е",A)+A}if(L("жшч",v))return S();if(O(y,v))return W(t,2)+"ок"}if(er.includes(i))return U(t)+"ей"
...
;if(i.endsWith("ни")&&O(y,M(i,3)))return["барышни","боярышни","деревни"].includes(i)?W(t,2)+"ень":i.endsWith("кухни")?W(t,2)+"онь":"сотни"===i?[W(t,2),W(t,2)+"ен"]:W(t,2)+"ен"
...
n("EEEEEEE-EEEEEE","левша"),r}(),(n=g(n))in r?Object.defineProperty(r,n,{value:t,enumerable:!0,configurable:!0,
writable:!0}):r[n]=t},[{key:"decline",value:function(e,r,n){return br(this,x.create(e),r,n)}},{key:"pluralize",
...
;if(i instanceof Array)return i.map(function(e){return new a(function(e){switch(1+(e>>3&7)){case c.V:return"в"
;case c.VO:return"во";case c.NA:return"на"}}(e),function(e,r,n,t){var i=5;switch(r){case 0:return Oe(e,n,i);case 1:
return Ve(e,n,t);case 2:return me(e,n,i);case 3:return be(e,n,i)}}(r,t,n,h(e)),e>>6)})}return[]}}])}()
;function br(e,n,t,i){var u=function(e,n,t,i){var u=n.text(),a=r.indexOf(t);if(n.isIndeclinable())return u
;if(n.isPluraleTantum())return Ar(e,n,a,u);if(i)return Ar(e,n,a,i);switch(n.getDeclension()){case-1:return u;case 0:
return Oe(e,n,a);case 1:return Fe(e,n,a);case 2:return me(e,n,a);case 3:return be(e,n,a)}}(e,n,t,i)
;return u instanceof Array?u:[u]}e.CASES=r,e.Case=n,e.Engine=Ir,e.Gender=u,e.Lemma=x,e.LocativeForm=a,
e.LocativeFormAttribute=s,e.StressDictionary=Y,e.createLemma=function(e){return x.create(e)},
e.createLemmaOrNull=function(e){return x.createOrNull(e)}});
