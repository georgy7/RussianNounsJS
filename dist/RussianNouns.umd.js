...
PREPOSITIONAL:1,U_SUFFIX:2}),f=Object.freeze({V:1,VO:2,NA:3});function c(e,r,n){return n<<6|(e-1&7)<<3|r-1&7}
...
var a,s=S(r);try{for(s.s();!(a=s.n()).done;){var f=a.value.charCodeAt(0)-1072&31;n|=f<<t,(t+=5)>=8&&u()}}catch(e){s.e(e)
}finally{s.f()}t>0&&u();var c=r.charCodeAt(0)%2;return 2*(2147483647&i)+c}function N(e){var r=e.charCodeAt(0)-1072
...
;if(2!==a.length||s(a[0],7)||s(a[1],6))throw new Error("Bad settings format.");var f=V.create(r),c=t(f),o=e.get(c)
;o instanceof Array||(o=[],e.set(c,o));var h=65535&f._flags|u(f)<<16,l=o.find(function(e){return h===e[0]})
;l?l[1]=i:o.push([h,i]),n.addInteger(f._hash)};var s=function(e){switch(e){case"E":return[!0];case"e":return[!0,!1]
;case"b":case"s":return[!1,!0];default:return[!1]}};this.hasStressedEndingSingular=function(e,t){
if(n.hasInteger(e._hash)){var u=r.indexOf(t);if(u>=0){var f=a(e);if(f){var c=f.split("-")[0];return s(c[u])}
...
var f=a(e);if(f){var c=f.split("-")[1];return s(c[u])}
...
;function fe(e,r){var n=U(r);if(O(-402111711,n)){if(O(T,R(r,2))){var t=w(e,2);return q(r,te)?t+K("ь",t):t}
if("й"!==n)return _(e)}return e}var ce=["ясень","бюллетень","олень","тюлень","гордень","пельмень","ячмень"]
;function oe(e,r,n){var t,u=e.text(),a=U(r),s=N(a);return-133667019&s&&(-402111711&s?t=function(e,r,n){var t=R(r,2)
;return"ь"===t||"о"===n&&O(2504708,t)?_(e):fe(e,r)}(u,r,a):"к"===a?t=function(e,r,n){
return e.length>=4&&M(r,["рёк","нёк","лёк"])&&!1!==n?w(e,2)+"ьк":r.endsWith("ёк")&&O(T,R(r,3))?w(e,2)+"йк":void 0
}(u,r,n):"ь"===a?t=function(e,r,n){
return ue.has(e._hash)||q(n,se)?w(r,3)+R(r,2):n.endsWith("ень")&&e.getGender()===i.MASCULINE&&!M(n,ce)?w(r,3)+"н":_(r)
...
return[i+"тей",i+"тею"]}}function Ne(e,r,t){var i=r.text(),u=r.lower(),a=oe(r,u),s=$(a),f=_(i),c=_(u),o=function(){
...
return l()||M(u,E)?a+"ей":h()?a+"ой":r.isASurname()&&!u.endsWith("да")?f+"ой":u.endsWith("ничья")?f+"ей":o()||O(60818504,U(s))?f+"и":f+"ы"
;case n.DATIVE:
return l()||M(u,E)?a+"ей":h()?a+"ой":r.isASurname()&&!u.endsWith("да")?f+"ой":"ия"===W(u,2)?f+"и":u.endsWith("ничья")?f+"ей":f+"е"
;case n.ACCUSATIVE:return h()?a+"ую":l()?a+"юю":o()?f+"ю":f+"у";case n.INSTRUMENTAL:
return l()||M(u,E)?a+"ею":h()?[a+"ой",a+"ою"]:o()||L("жшчщц",U(s))&&!e.sd.hasStressedEndingSingular(r,t).includes(!0)?"и"===U(c)?f+"ей":[f+"ей",f+"ею"]:[f+"ой",f+"ою"]
...
;function t(r,n,t,i,u){var a,f=i.split(","),o=u instanceof Array?u:[s.U_SUFFIX],h=S(f);try{for(h.s();!(a=h.n()).done;){
var l=a.value;r.text=l;var E=Ce(V.create(r)),d=e.get(E);d||(d=[],e.set(E,d));var I,v=S(t);try{
for(v.s();!(I=v.n()).done;){var A,p=I.value,N=S(o);try{for(N.s();!(A=N.n()).done;){var O=A.value;d.push(c(p,O,n))}
}catch(e){N.e(e)}finally{N.f()}}}catch(e){v.e(e)}finally{v.f()}}}catch(e){h.e(e)}finally{h.f()}}
var u=[f.V],o=[f.VO],h=[f.NA];t(r,a.CONTAINER,u,"мозг,пруд,стог,таз,год"),t(r,a.CONTAINER,o,"рот"),t(r,a.WAY,u,"год"),
...
;function Me(e,r,t){
var u=r.text(),a=$(u),s=U(a),f=r.getGender(),c=e.sd.hasStressedEndingSingular(r,t),h=oe(r,a,c[0]),l=_(u),E=Pe(a)
...
return!r.isAnimate()&&ye.hasInteger(r._hash)&&me.has(a)&&("й"===s?e.push(_(u)+K("ю",U(u))):e=e.concat(Ie(c,h,function(e){
...
if(M(a,["шко"])&&i.MASCULINE===f)return l+"и"}return p(r.isASurname()||-1===d.indexOf("ё")?[h+"а"]:Ie(c,h,function(e){
...
if(Se(a))return _(l)+"ку"}return r.isASurname()||-1===d.indexOf("ё")?h+"у":Ie(c,h,function(e){return e+"у"})
;case n.ACCUSATIVE:return f===i.NEUTER||L("иы",s)&&E?u:r.isAnimate()?Me(e,r,n.GENITIVE):u;case n.INSTRUMENTAL:switch(s){
...
return Ie(c,u,function(e,n){return n?he(e,r)+"цом":he(e,r)+"цем"});case"к":if(Se(a))return _(l)+"ком";break;case"н":
case"в":if(r.isASurname()&&q(a,Oe))return u+"ым"}return S()||L("жшчщ",U(d))?Ie(c,h,function(e,r){return r?e+"ом":e+"ем"
}):r.isASurname()||-1===d.indexOf("ё")?h+"ом":Ie(c,h,function(e){return e+"ом"});case n.LOCATIVE:
...
return r.isASurname()||-1===d.indexOf("ё")?h+"е":Ie(c,h,function(e){return e+"е"})}}function Ve(e,r,n,t){
...
var i=r.text(),u=r.lower(),a=oe(r,u),f=_(i),c=Pe(u)&&u.endsWith("я")||xe(u)
;return"й"===U(u)?y(f)+"ю":c?y(a)+"ю":Se(u)?y(_(f))+"ку":y(a)+"у"}if(s.PREPOSITIONAL===t)return Me(e,r,n.PREPOSITIONAL)}
...
;var f=oe(r,a,s[0]),c=$(f);if(a.endsWith("яя"))return t.push(w(u,2)+"ие"),ge(t);var o=function(t){
var i=e.sd.hasStressedEndingPlural(r,n.NOMINATIVE).map(function(e){return!e});return i.length?i.map(function(e){
return e?1===c.replace(/[^её]/g,"").length?t(function(e){
var r=Math.max(e.toLowerCase().lastIndexOf("е"),e.toLowerCase().lastIndexOf("ё")),n=K("ё",e[r])
;return e.substring(0,r)+n+e.substring(r+1)}(f)):t(f):t(y(f))}):[t(f)]
},h=r.getGender(),l=r.getDeclension(),E=("й"===U(a)||O(T,U(a)))&&O(T,U(_(a)))?_(u):f,d=function(){
...
O(60818504,U(c))||L("яйь",U(a))||M(a,["сосед"])?d()?(t.push(v()+"и"),
...
for(u.s();!(n=u.n()).done;){var a=I(n.value,2),s=a[0],f=a[1],c=s[0],o=s[1]
;if(t===c&&(null==o||o===i)&&f.hasOwnProperty(r))return f[r].slice()}}catch(e){u.e(e)}finally{u.f()}}}(r,a)
;if(p)return p;var N="ь"===U(c)?f:"к"===U(c)?_(f)+"чь":"г"===U(c)?_(f)+"зь":"й"===U(a)?_(u):M(a,["рь","ль"])?f:f+"ь"
...
xe(a)?Array.prototype.push.apply(t,o(function(e){return e+"я"})):s.includes(!0)?t.push(y(f)+"а"):t.push(f+"а"),
...
}else if(i.NEUTER===h)if(M(a,["ко","чо"])&&!M(a,["войско","облако"]))t.push(_(u)+"и");else if(a.endsWith("имое"))t.push(f+"ые");else if(a.endsWith("ее"))t.push(f+"ие");else if(a.endsWith("ое"))M(c,["г","к","ж","ш","х"])?t.push(f+"ие"):t.push(f+"ые");else if(M(a,["ие","иё"]))t.push(w(u,2)+"ия");else if(M(a,["ье","ьё"])){
...
}else M(a,["дерево","звено","крыло"])?t.push(f+"ья"):M(a,["ле","ре"])?t.push(f+"я"):a.endsWith("судно")&&r.isATransport()?t.push(w(u,2)+"а"):(Array.prototype.push.apply(t,o(function(e){
return e+"а"})),M(a,["щупальце"])&&A());else t.push(f+"и");break;case 2:
"заря"===a?t.push("зори"):a.endsWith("ая")&&!a.endsWith("свая")?L("жхчшщ",U(c))||M(c,["вк","гк","ск","цк","ньк"])?t.push(f+"ие"):t.push(f+"ые"):A()
;break;case 3:
"мя"===W(a,2)?t.push(f+"ена"):Object.keys(ve).includes(a)?t.push(_(ve[a])+"и"):i.FEMININE===h?t.push(E+"и"):"и"===U(E)?t.push(E+"я"):t.push(E+"а")
}return ge(t)}
...
;var fr=["х","ых","их","м","ым","им","х","ых","их","ми","ыми","ими","х","ых","их"],cr=["ям","ам","","","ями","ами","ях","ах"],or=Y(["вна","вца","вцы","пла","дца","дра","судна","рки","рцы","тлы","рна","тна","енца","десны","дёсны","рёбра","ребра","сосны"]),hr=Y(["жи","ши","чи","ля","ли","чи","ри","ти","ди","сани","борщи","клещи","товарищи","плащи","прыщи","хрящи"]),lr=Y(["братья","брусья","деревья","донья","звенья","клинья","клочья","коленья","колосья","колья","комья","крылья","крючья","листья","лоскутья","лохмотья","перья","платья","поводья","прутья","стулья","сучья","хлопья","шилья"]),Er=Y(["ишки","дружки","тки","папочки","дедушки","дядюшки","батюшки","катанки","петрушки","шестерки"]),dr=Y(["жки","шки","чки","рки","натки","хатки","ятки","етки","чётки","мки","нки","педки","илки"]),Sr=Y(["шок","щок","жок","зок","аток","яток","еток"])
;function Ir(e,n,t,u){var a=$(u),s=U(a),f=N(s),c=r.indexOf(t)+1;if(1===c||4===c&&!n.isAnimate())return u
;if(134217984&f)if(2===c||4===c){if(M(a,["овичи","евичи"]))return _(u)+"ей"
;if(M(a,["вны","полусотни"])&&"овны"!==a)return w(u,2)+"ен"}else if(5===c){
if(M(a,["дети","люди"])&&!M(a,["нелюди"]))return _(u)+"ьми";if(M(a,["вери","дочери"]))return[_(u)+"ями",_(u)+"ьми"]}
var o=n.getGender(),h=a.endsWith("цы")?_(u):fe(u,a),l=q(a,Te)&&(n.isASurname()||o===i.COMMON)&&!q(a,Ze),E=3*Math.min(Math.round(fr.length/3-1),c-2)
;if(l||a.endsWith("ничьи"))return u+fr[E];if(a.endsWith("ые"))return w(u,2)+fr[E+1]
;if(a.endsWith("ие")||q(a,ie))return h+fr[E+2];if(c>2&&4!==c){var d=2*Math.min(Math.round(cr.length/2-1),c-3)
;return q(a,$e)?_(u)+cr[d]:e.sd.hasStressedEndingPlural(n,t).includes(!0)?y(h)+cr[d+1]:h+cr[d+1]}
...
var s=U(h);return _(h)+K("о",s)+s}if(q(a,or)&&!a.endsWith("недра")||M(a,i)){var f=R(u,2);return w(u,2)+K("е",f)+f}
if(M(a,["сестры","сёстры","серьги"])){var c=R(u,2);return("ь"===R(a,3)?y(w(u,3)):y(w(u,2)))+K("ё",c)+c}
...
;if(i instanceof Array)return i.map(function(e){return new u(function(e){switch(1+(e>>3&7)){case f.V:return"в"
;case f.VO:return"во";case f.NA:return"на"}}(e),function(e,r,n,t){switch(r){case 0:return pe(e,n,Case.PREPOSITIONAL)
...
;case 3:return Ae(e,r,n)}}(e,r,n,t);return i instanceof Array?i:[i]}e.CASES=r,e.Case=n,e.Engine=vr,e.Gender=i,e.Lemma=V,
e.LocativeForm=u,e.LocativeFormAttribute=a,e.StressDictionary=X,e.createLemma=function(e){return V.create(e)},
e.createLemmaOrNull=function(e){return V.createOrNull(e)}});
