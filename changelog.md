...
## [2.5.0] - 2026-01-06
### Added
- Unexpectedly fast function `toLowerCaseRu(s)`
- Bloom filters in `declinePlural`
- ECMAScript 5 version of the script (requires `core-js` to run on ES5-only engines)

### Fixed
- Pluralization correctness has reached 99%
