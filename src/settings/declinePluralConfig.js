...
export const EXPLICIT_OV1 = [
    ...
    'юнкера', 'ястреба',
    'суда', 'корм',
    // animate professions with -а nom.pl that take -ов gen.pl
    'авиаконструктора', 'автоинспектора', 'госавтоинспектора',
    'конструктора', 'корректора', 'редактора', 'санинструктора',
    'хутора', 'мини-трактора', 'сектора',
    'пристава', 'проспектора', 'ректора',
    'фельдшера', 'кучера', 'вахтера',
    'лекаря', 'писаря',
    'пуделя'
];
